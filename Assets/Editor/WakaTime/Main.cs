...
namespace WakaTime
{
	...
	[SuppressMessage("ReSharper", "SA1623", Justification = "Hiding errors as is not my script.")]
	[SuppressMessage("ReSharper", "SA1201", Justification = "Hiding errors as is not my script.")]
	...
	public class Main
	{
		...
		public static string ApiKey
		{
			get
			{
				if (_apiKey == null)
				{
					_apiKey = EditorPrefs.GetString(KEY_API_KEY, string.Empty);
				}
        ...
        /// <summary>
        /// Initializes static members of the <see cref="Main"/> class.
